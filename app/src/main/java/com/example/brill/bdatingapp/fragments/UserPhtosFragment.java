...
public class UserPhtosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootitem= inflater.inflate(R.layout.fragment_user_phtos, container, false);
    ...
    private void findviewbyidmethod(View rootitem) {
        ...
        sharid= prefrance.getString("selectuserid","");
        VisitUserPhotos();
    }
                        ...
                        try {
                            ...
                            else
                            {
                                ...
                                if(!photo1.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo1;
                                ...
                                if(!photo2.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo2;
                                ...
                                if(!photo3.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo3;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
                                ...
                                if(!photo4.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo4;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
                                ...
                                if(!photo5.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo5;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
                                ...
                                if(!photo6.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo6;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
                                ...
                                if(!photo7.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo7;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
                                ...
                                if(!photo8.equals(""))
                                {
                                    ...
                                    String url="http://www.bdating.in/img/photo/"+photo8;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
                                ...
                                {
                                    immBtn2.setVisibility(View.VISIBLE);
                                    String url="http://www.bdating.in/img/photo/"+photo9;
                                    Log.i("","=======photo from shared pref=======2222222"+url);
