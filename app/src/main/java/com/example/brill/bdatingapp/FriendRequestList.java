...
import com.example.brill.bdatingapp.adapter.AdapterFriendRequestList;
...
public class FriendRequestList extends AppCompatActivity {
    ...
    private AdapterFriendRequestList recyclerAdapter;
    private ArrayList<GatterGetAllFriendRequestList> recyclerModels;

    List<GatterGetAllFriendRequestList> GetDataAdapter1;
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   if(isinternetpresent) {
            ...
            recyclerAdapter = new AdapterFriendRequestList(recyclerModels,this);
...
/*
    ...
    private void filter(String text) {
        ...
        ArrayList<GatterGetAllFriendRequestList> filteredname=new ArrayList<>();

        for (GatterGetAllFriendRequestList s : recyclerModels) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                  ...
                                  String  userId, uname,gender,birthday,city,profile_pic;
                                    ...
                                    recyclerModels.add(new GatterGetAllFriendRequestList(userId, uname,gender,birthday,city,profile_pic));
