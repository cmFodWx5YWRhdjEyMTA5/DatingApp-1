...
import com.example.brill.bdatingapp.gattersatter.GatterGetAllFriendRequestList;
...
public class AdapterFriendRequestSended extends RecyclerView.Adapter<AdapterFriendRequestSended.MyViewHolder> {
    ...
    private ArrayList<GatterGetAllFriendRequestSended> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterFriendRequestSended(ArrayList<GatterGetAllFriendRequestSended> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterFriendRequestSended.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterFriendRequestSended.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetAllFriendRequestSended getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(int pos) {
                    ...
                    if (isinternetpresent) {
                        ...
                        editor.putString("selecttype","FriendRequestsend");
    ...
    public void filterList(ArrayList<GatterGetAllFriendRequestSended> filterdNames) {
