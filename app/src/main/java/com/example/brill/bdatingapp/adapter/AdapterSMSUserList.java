...
import com.example.brill.bdatingapp.gattersatter.GatterGetSMSUserList;
import com.example.brill.bdatingapp.sendSmsActivity;
...
public class AdapterSMSUserList extends RecyclerView.Adapter<AdapterSMSUserList.MyViewHolder> {

    SharedPreferences prefrance,msharedprefrance;
    ...
    private ArrayList<GatterGetSMSUserList> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterSMSUserList(ArrayList<GatterGetSMSUserList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterSMSUserList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterSMSUserList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetSMSUserList getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;


        msharedprefrance=context.getSharedPreferences(Configs.UserPrefrance, Context.MODE_PRIVATE);
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(int pos) {
                    ...
                    if (isinternetpresent) {
                        ...
                        prefrance = context.getSharedPreferences("selectedUserSMS", Context.MODE_PRIVATE);
                        ...
                        editor.putString("selectuserphone", getUserdtl.getPhone());
    ...
    public void filterList(ArrayList<GatterGetSMSUserList> filterdNames) {
