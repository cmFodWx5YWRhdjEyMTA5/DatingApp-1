...
public class AdapterGetNearBy extends RecyclerView.Adapter<AdapterGetNearBy.MyViewHolder> {
    ...
    private ArrayList<GatterNearBy> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterGetNearBy(ArrayList<GatterNearBy> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterGetNearBy.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterGetNearBy.MyViewHolder holder, int position) {
        // update your data here
        final GatterNearBy getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(int pos) {
                    ...
                    if (isinternetpresent) {
                        ...
                        Intent i = new Intent(context, VisitUserProfileActivity.class);
    ...
    public void filterList(ArrayList<GatterNearBy> filterdNames) {
