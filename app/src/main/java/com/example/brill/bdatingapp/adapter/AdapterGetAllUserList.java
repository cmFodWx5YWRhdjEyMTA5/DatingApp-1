...
import com.example.brill.bdatingapp.gattersatter.GatterGetAllUserInfo;
...
public class AdapterGetAllUserList extends RecyclerView.Adapter<AdapterGetAllUserList.MyViewHolder> {
...
String userphoto;
    String prefid="id",prefupid="upid",preftitle="title",prefdate="date",prefuploader="uploader",prefimages="images",prefdetails="details",prefvideo="video",prefphoto1="photo1",prefphoto2="photo2",prefphoto3="photo3",prefphoto4="photo5",prefphoto6="photo7",prefphoto8="photo8",prefphoto9="photo9";
    private ArrayList<GatterGetAllUser> recyclerModels;
    private ArrayList<GatterGetAllUserInfo> recyclerM;
    // this data structure carries our title and description
    Context context;
    public AdapterGetAllUserList(ArrayList<GatterGetAllUser> recyclerModels,Context context) {
        this.recyclerModels = recyclerModels;
        //this.recyclerM = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterGetAllUserList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterGetAllUserList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetAllUser getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
        String userid, username="",usergender,userDOB,userstate,usercity,userPic,userphoto1;
        Button bopenpr;
        ...
        Log.i("","siiiiiharidooooooooooo"+sharid);
        userid = getUserdtl.getUserId();

        if(!sharid.equals(userid))

        {
            ...
            userphoto=getUserdtl.getPhoto1();
            String sortGender = "";


            if (username.equals("poo")) {
                Log.i("", "poooooooooooo" + usergender);
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(int pos) {
                    ...
                    if (isinternetpresent) {
                        ...
                        editor.putString("photo1",getUserdtl.getPhoto1());
                        editor.commit();

                        Intent intent = new Intent(context, VisitUserProfileActivity.class);
                        /*Bundle bundle = new Bundle();
                        bundle.putSerializable("info",recyclerModels);
                        intent.putExtras(bundle);
                        intent.putExtra("position",pos);
                        intent.putExtra("classtype","allUser");*/
    ...
    public void filterList(ArrayList<GatterGetAllUser> filterdNames) {
        this.recyclerModels = filterdNames;
        notifyDataSetChanged();
    }

    public GatterGetAllUser getItem(int position) {
