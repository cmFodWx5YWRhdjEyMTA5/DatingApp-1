...
import com.example.brill.bdatingapp.adapter.AdapterMyBlockedList;
 ...
 */
public class MyBlockListFragment extends android.support.v4.app.Fragment {
    ProgressBar progressBar;
    JsonArrayRequest jsonArrayReq;
    RequestQueue requestQueue;

    private AdapterMyBlockedList recyclerAdapter;
    private ArrayList<GatterGetMyBlockedList> recyclerModels;


    List<GatterGetMyBlockedList> GetDataAdapter1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_my_block_list, container, false);
        ...
        recyclerAdapter = new AdapterMyBlockedList(recyclerModels,getActivity());
...
/*
    ...
    private void getAllMyFavourites() {
        ...
        String JSON_URL= Configs.GetAllBlockbymeList+"?limit=16&LoadData=yes&cuserid="+SharedintId;
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                recyclerModels.add(new GatterGetMyBlockedList(lastId, fname));
...
*/
        ...
        String urls= Configs.GetAllBlockbymeList+"?lastGetDataLength="+LastGetDataLength+"&MoreData=yes&limit=16&cuserid="+SharedintId;
