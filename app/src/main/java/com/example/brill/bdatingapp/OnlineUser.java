...
public class OnlineUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_online_user);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        final SharedPreferences msharedprefrance=OnlineUser.this.getSharedPreferences(Configs.UserPrefrance,MODE_PRIVATE);
        ...
        recyclerAdapter = new AdapterOnlineUser(recyclerModels,OnlineUser.this);
        GetDataAdapter1 = new ArrayList<>();


        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.loadmore_recycler_view);

        recyclerlayoutManager=new GridLayoutManager(OnlineUser.this,2);
    ...
    private void getOnlineUser() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configs.GetOnlineUser,
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                    ...
                                    String  userId, uname,gender,birthday,city,profile_pic,user_status;
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                      //  Toast.makeText(OnlineUser.this, error.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        VolleySingleton.getInstance(OnlineUser.this).addToRequestQueue(stringRequest);
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configs.GetOnlineUser,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.equals("[]")) {
                            ...
                            // something
                            Toasty.info(OnlineUser.this, "no data available", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressBar.setVisibility(View.GONE);
                        itShouldLoadMore = true;
                        Toasty.error(OnlineUser.this, "Failed to load more, network error", Toast.LENGTH_SHORT).show();
