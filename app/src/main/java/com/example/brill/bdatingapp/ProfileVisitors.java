...
import com.example.brill.bdatingapp.adapter.AdapterFriendList1;
...
public class ProfileVisitors extends AppCompatActivity {
    ...
    private AdapterFriendList1 recyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new AdapterFriendList1(recyclerModels,this);
