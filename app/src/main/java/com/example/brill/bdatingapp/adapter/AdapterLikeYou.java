...
import com.example.brill.bdatingapp.gattersatter.GatterGetAllLikeYou;
...
public class AdapterLikeYou extends RecyclerView.Adapter<AdapterLikeYou.MyViewHolder> {
    ...
    private ArrayList<GatterGetAllLikeYou> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterLikeYou(ArrayList<GatterGetAllLikeYou> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterLikeYou.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterLikeYou.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetAllLikeYou getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
    ...
    public void filterList(ArrayList<GatterGetAllLikeYou> filterdNames) {
