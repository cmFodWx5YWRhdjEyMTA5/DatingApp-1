...
public class AdapterFriendList_SMS extends RecyclerView.Adapter<AdapterFriendList_SMS.MyViewHolder> {
    ...
    Context context;
    public AdapterFriendList_SMS(ArrayList<GatterGetAllFriendList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterFriendList_SMS.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterFriendList_SMS.MyViewHolder holder, int position) {
