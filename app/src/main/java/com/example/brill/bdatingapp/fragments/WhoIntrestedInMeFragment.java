...
import com.example.brill.bdatingapp.adapter.AdapterGetWhoIntrestedInMe;
 ...
 */
public class WhoIntrestedInMeFragment extends android.support.v4.app.Fragment {
    ProgressBar progressBar;
    JsonArrayRequest jsonArrayReq;
    RequestQueue requestQueue;

    private AdapterGetWhoIntrestedInMe recyclerAdapter;
    private ArrayList<GatterGetWhoIntrestedInMeList> recyclerModels;
    ...
    public WhoIntrestedInMeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_who_intrested_in_me, container, false);
        ...
        recyclerAdapter = new AdapterGetWhoIntrestedInMe(recyclerModels,getActivity());
...
/*
    ...
    private void getAllMyFavourites() {
        ...
        String JSON_URL= Configs.GetAllWhoIntrestedMeList+"?limit=16&LoadData=yes&cuserid="+SharedintId;
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                recyclerModels.add(new GatterGetWhoIntrestedInMeList(lastId, fname));
...
*/
        ...
        String urls= Configs.GetAllMyFavouritesUrl+"?lastGetDataLength="+LastGetDataLength+"&MoreData=yes&limit=16&cuserid="+SharedintId;
