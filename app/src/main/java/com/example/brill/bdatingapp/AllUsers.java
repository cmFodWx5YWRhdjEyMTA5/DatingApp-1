...
public class AllUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdrawer = (DrawerLayout)findViewById(R.id.nav_view);
        ...
        recyclerAdapter = new AdapterGetAllUserList(recyclerModels,AllUsers.this);
        GetDataAdapter1 = new ArrayList<>();


        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.loadmore_recycler_view);

        recyclerlayoutManager=new GridLayoutManager(AllUsers.this,2);
    ...
    private void getAllUsers() {
        ...
        VolleySingleton.getInstance(AllUsers.this).addToRequestQueue(stringRequest);
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configs.GetAllUser,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.equals("[]")) {
                            ...
                            // something
                            Toasty.info(AllUsers.this, "no data available", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressBar.setVisibility(View.GONE);
                        itShouldLoadMore = true;
                        Toasty.error(AllUsers.this, "Failed to load more, network error", Toast.LENGTH_SHORT).show();
