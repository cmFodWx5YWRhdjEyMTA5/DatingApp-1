...
import com.example.brill.bdatingapp.Activity_GetPlanAndPrice;
...
public class AdapterGetStandardPlans extends RecyclerView.Adapter<AdapterGetStandardPlans.MyViewHolder> {
    ...
    private ArrayList<GatterGetStandardplans> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterGetStandardPlans(ArrayList<GatterGetStandardplans> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterGetStandardPlans.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_allplansitem, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterGetStandardPlans.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetStandardplans getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
...
*/
    ...
    public void filterList(ArrayList<GatterGetStandardplans> filterdNames) {
        this.recyclerModels = filterdNames;
        notifyDataSetChanged();
    }

    public GatterGetStandardplans getItem(int position) {
