...
import com.example.brill.bdatingapp.adapter.AdapterBlockUserList;
...
public class BlockUserList extends AppCompatActivity {
    ...
    private AdapterBlockUserList recyclerAdapter;
    private ArrayList<GatterGetBlockUserList> recyclerModels;

    List<GatterGetBlockUserList> GetDataAdapter1;
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   if(isinternetpresent) {
            ...
            recyclerAdapter = new AdapterBlockUserList(recyclerModels,this);
...
/*
    ...
    private void filter(String text) {
        ...
        ArrayList<GatterGetBlockUserList> filteredname=new ArrayList<>();

        for (GatterGetBlockUserList s : recyclerModels) {
    ...
    private void getAllBlockUsers() {
        progressBar.setVisibility(View.VISIBLE);
        progressBar.setClickable(false);
        Log.i("","Configs.GetAllUser========"+ Configs.BlockedList);
        //if everything is fine
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configs.BlockedList,
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                  ...
                                  String  userId, uname,gender,birthday,city,profile_pic;
                                    ...
                                    recyclerModels.add(new GatterGetBlockUserList(userId, uname,gender,birthday,city,profile_pic));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configs.GetAllFriendRequestList,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        {
                            Toasty.info(getApplicationContext(), "No New Friend Request", Toast.LENGTH_SHORT).show();
                            return;
                        }
