...
public class AdapterFriendList1 extends RecyclerView.Adapter<AdapterFriendList1.MyViewHolder> {
    ...
    Context context;
    public AdapterFriendList1(ArrayList<GatterGetAllFriendList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterFriendList1.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterFriendList1.MyViewHolder holder, int position) {
