...
import com.example.brill.bdatingapp.adapter.AdapterUserMessages;
...
public class UserMessages extends AppCompatActivity {
    ...
    private AdapterUserMessages recyclerAdapter;
    private ArrayList<GatterGetUserMessage> recyclerModels;

    List<GatterGetUserMessage> GetDataAdapter1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new AdapterUserMessages(recyclerModels,this);
...
/*
    ...
    private void filter(String text) {
        ...
        ArrayList<GatterGetUserMessage> filteredname=new ArrayList<>();

        for (GatterGetUserMessage s : recyclerModels) {
            if(s.getName().toLowerCase().startsWith(text))
            {
                filteredname.add(s);
            }
        }
    ...
    private void getAllUsersMessages() {
        progressBar.setVisibility(View.VISIBLE);
        progressBar.setClickable(false);
        Log.i("","Configs.GetAllUser========"+ Configs.GetAllFriend);
        //if everything is fine
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configs.GetAllUserMessages,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {                                try {
                                ...
                                recyclerModels.add(new GatterGetUserMessage(senderid,name,gender,birthday,profile_pic));
                            ...
                            else
                            {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    try {
                                        ...
                                        recyclerModels.add(new GatterGetUserMessage(userId, uname,gender,birthday,city,profile_pic));
                                        recyclerAdapter.notifyDataSetChanged();
                                    }
                                    catch (JSONException e) {
                                        e.printStackTrace();
