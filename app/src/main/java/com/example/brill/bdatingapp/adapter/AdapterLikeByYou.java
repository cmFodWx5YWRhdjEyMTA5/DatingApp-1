...
public class AdapterLikeByYou extends RecyclerView.Adapter<AdapterLikeByYou.MyViewHolder> {
    ...
    private ArrayList<GatterGetAllLikeByYou> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterLikeByYou(ArrayList<GatterGetAllLikeByYou> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterLikeByYou.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterLikeByYou.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetAllLikeByYou getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
    ...
    public void filterList(ArrayList<GatterGetAllLikeByYou> filterdNames) {
