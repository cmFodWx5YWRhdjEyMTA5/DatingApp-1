...
public class AdapterFriendRequestList extends RecyclerView.Adapter<AdapterFriendRequestList.MyViewHolder> {
    ...
    private ArrayList<GatterGetAllFriendRequestList> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterFriendRequestList(ArrayList<GatterGetAllFriendRequestList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterFriendRequestList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterFriendRequestList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetAllFriendRequestList getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
    ...
    public void filterList(ArrayList<GatterGetAllFriendRequestList> filterdNames) {
