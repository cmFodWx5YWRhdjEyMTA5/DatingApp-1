...
public class AdapterOnlineUser extends RecyclerView.Adapter<AdapterOnlineUser.MyViewHolder> {
    ...
    Context context;
    public AdapterOnlineUser(ArrayList<GatterOnlineUser> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterOnlineUser.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item3, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterOnlineUser.MyViewHolder holder, int position) {
