...
import com.example.brill.bdatingapp.fragments.LikesUserByYou;
import com.example.brill.bdatingapp.fragments.FriendRequestReceived;
import com.example.brill.bdatingapp.fragments.LikesYou;
...
public class Like extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitylikes);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
             adapter.addFragment(new LikesUserByYou(),"Likes By You");
        adapter.addFragment(new LikesYou(),"Likes You");
