...
public class AdapterQuickSearchUserList extends RecyclerView.Adapter<AdapterQuickSearchUserList.MyViewHolder> {
    ...
    private ArrayList<GatterGetQuickUserList> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterQuickSearchUserList(ArrayList<GatterGetQuickUserList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterQuickSearchUserList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterQuickSearchUserList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetQuickUserList getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
    ...
    public void filterList(ArrayList<GatterGetQuickUserList> filterdNames) {
