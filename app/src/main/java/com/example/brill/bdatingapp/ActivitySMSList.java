...
import com.example.brill.bdatingapp.adapter.AdapterFriendList_SMS;
...
public class ActivitySMSList extends AppCompatActivity {

    ProgressBar progressBar;
    JsonArrayRequest jsonArrayReq;
    RequestQueue requestQueue;

    private AdapterFriendList_SMS recyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new AdapterFriendList_SMS(recyclerModels,this);
