...
public class AdapterGetIAmThereFavourites extends RecyclerView.Adapter<AdapterGetIAmThereFavourites.MyViewHolder> {
    ...
    private ArrayList<GatterGetIAmTheirFavourites> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterGetIAmThereFavourites(ArrayList<GatterGetIAmTheirFavourites> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterGetIAmThereFavourites.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.all_user_list, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterGetIAmThereFavourites.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetIAmTheirFavourites getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
