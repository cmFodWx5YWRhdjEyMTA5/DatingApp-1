...
public class AdapterFriendList extends RecyclerView.Adapter<AdapterFriendList.MyViewHolder> {
    ...
    Context context;
    public AdapterFriendList(ArrayList<GatterGetAllFriendList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterFriendList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterFriendList.MyViewHolder holder, int position) {
