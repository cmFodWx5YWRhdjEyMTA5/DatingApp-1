...
public class AdapterGetViewedMyProfile extends RecyclerView.Adapter<AdapterGetViewedMyProfile.MyViewHolder> {
    ...
    private ArrayList<GatterGetViewedMyProfile> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterGetViewedMyProfile(ArrayList<GatterGetViewedMyProfile> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterGetViewedMyProfile.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.all_user_list, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterGetViewedMyProfile.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetViewedMyProfile getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
