...
import com.example.brill.bdatingapp.gattersatter.GatterGetPlatinumplans;
...
public class AdapterGetPlatniumPlans extends RecyclerView.Adapter<AdapterGetPlatniumPlans.MyViewHolder> {
 ...
 //   SharedPreferences prefrance,prefranceid;
    ...
    @Override
    public AdapterGetPlatniumPlans.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_allplansitem, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterGetPlatniumPlans.MyViewHolder holder, int position) {
