...
public class AdapterLikeUserList extends RecyclerView.Adapter<AdapterLikeUserList.MyViewHolder> {
    ...
    private ArrayList<GatterGetLikesUserList> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterLikeUserList(ArrayList<GatterGetLikesUserList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterLikeUserList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterLikeUserList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetLikesUserList getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
    ...
    public void filterList(ArrayList<GatterGetLikesUserList> filterdNames) {
