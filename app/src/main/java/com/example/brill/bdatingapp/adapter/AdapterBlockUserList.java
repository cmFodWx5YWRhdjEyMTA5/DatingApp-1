...
public class AdapterBlockUserList extends RecyclerView.Adapter<AdapterBlockUserList.MyViewHolder> {
    ...
    private ArrayList<GatterGetBlockUserList> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterBlockUserList(ArrayList<GatterGetBlockUserList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterBlockUserList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterBlockUserList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetBlockUserList getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(int pos) {
                    ...
                    if (isinternetpresent) {
                        ...
                        intent.putExtra("classtype","block");
    ...
    public void filterList(ArrayList<GatterGetBlockUserList> filterdNames) {
