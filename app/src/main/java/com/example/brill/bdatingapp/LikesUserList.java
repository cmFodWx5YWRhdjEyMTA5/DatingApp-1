...
import com.example.brill.bdatingapp.adapter.AdapterLikeUserList;
import com.example.brill.bdatingapp.gattersatter.GatterGetBlockUserList;
import com.example.brill.bdatingapp.gattersatter.GatterGetLikesUserList;
 ...
 */
public class LikesUserList extends AppCompatActivity {
    ProgressBar progressBar;
    JsonArrayRequest jsonArrayReq;
    RequestQueue requestQueue;

    private AdapterLikeUserList recyclerAdapter;
    private ArrayList<GatterGetLikesUserList> recyclerModels;
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   if(isinternetpresent) {
            ...
            recyclerAdapter = new AdapterLikeUserList(recyclerModels,this);
...
/*
    ...
    private void filter(String text) {
        ...
        ArrayList<GatterGetLikesUserList> filteredname=new ArrayList<>();

        for (GatterGetLikesUserList s : recyclerModels) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                  ...
                                  String  userId, uname,gender,birthday,city,profile_pic;
                                    ...
                                    recyclerModels.add(new GatterGetLikesUserList(userId, uname,gender,birthday,city,profile_pic));
