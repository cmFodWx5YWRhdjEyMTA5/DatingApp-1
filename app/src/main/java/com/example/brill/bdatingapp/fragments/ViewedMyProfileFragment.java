...
import com.example.brill.bdatingapp.adapter.AdapterGetViewedMyProfile;
import com.example.brill.bdatingapp.gattersatter.GatterGetViewedMyProfile;
 ...
 */
public class ViewedMyProfileFragment extends android.support.v4.app.Fragment {

    ProgressBar progressBar;
    JsonArrayRequest jsonArrayReq;
    RequestQueue requestQueue;

    private AdapterGetViewedMyProfile recyclerAdapter;
    private ArrayList<GatterGetViewedMyProfile> recyclerModels;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_viewer_my_profile, container, false);
        ...
        recyclerAdapter = new AdapterGetViewedMyProfile(recyclerModels,getActivity());
...
/*
    ...
    private void getAllMyFavourites() {
        ...
        String JSON_URL= Configs.GetAllMyFavouritesUrl+"?limit=16&LoadData=yes&cuserid="+SharedintId;
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                recyclerModels.add(new GatterGetViewedMyProfile(lastId, fname));
...
*/
        ...
        String urls= Configs.GetAllmyProfileViewer+"?lastGetDataLength="+LastGetDataLength+"&MoreData=yes&limit=16&cuserid="+SharedintId;
