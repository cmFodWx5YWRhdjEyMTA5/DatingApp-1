...
public class AdapterChatList extends RecyclerView.Adapter<AdapterChatList.MyViewHolder> {
    ...
    private ArrayList<GatterGetAllChatList> recyclerModels; // this data structure carries our title and description
    Context context;
    public AdapterChatList(ArrayList<GatterGetAllChatList> recyclerModels, Context context) {
        this.recyclerModels = recyclerModels;
        this.context=context;
    }

    @Override
    public AdapterChatList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate your custom row layout here
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_alluser_item_1, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterChatList.MyViewHolder holder, int position) {
        // update your data here
        final GatterGetAllChatList getUserdtl = recyclerModels.get(position);
        //getUserdtl=getAda1;
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(int pos) {
                    ...
                    if (isinternetpresent) {
                        ...
                        editor.putString("selectuseridpic", getUserdtl.getProfile());
                        editor.commit();
    ...
    public void filterList(ArrayList<GatterGetAllChatList> filterdNames) {
